    ...
    for (const lang of languages) {
        test(`Desktop view - ${lang}`, async ({ browser }) => {
            ...
            try {
                ...
                await page.waitForSelector('.elementor-element[data-id="b47722d"]', { 
                    state: 'visible',
                    timeout: 10000
                }).catch(error => {
                ...
                const result = await comparePageScreenshot(
                    page,
                    `StammzellentherapiePage-Full-${lang}`,
        ...
        test(`Mobile view - ${lang}`, async ({ browser }) => {
            ...
            try {
                ...
                try {
                    ...
                    await page.waitForSelector('.elementor-element[data-id="b47722d"]', { state: 'visible', timeout: 10000 });
                } catch (error) {
                ...
                const result = await comparePageScreenshot(
                    page,
                    `StammzellentherapiePage-Mobile-${lang}`,
                    'StammzellentherapiePage',
                    test.info(),
                    {
                        threshold: 0.3,
