    ...
    for (const lang of languages) {
        test(`Desktop view - ${lang}`, async ({ browser }) => {
            ...
            try {
                ...
                const url = lang === 'de' ? '/bewegungsapparat/' : `/${lang}/bewegungsapparat/`;
                ...
                await page.waitForSelector('.elementor-element[data-id="8d0b772"]', { 
                    state: 'visible',
                    timeout: 10000
                }).catch(error => {
        ...
        test(`Mobile view - ${lang}`, async ({ browser }) => {
            ...
            try {
                ...
                try {
                    ...
                    await page.waitForSelector('.elementor-element[data-id="8d0b772"]', { state: 'visible', timeout: 10000 });
