    ...
    for (const lang of languages) {
        test(`Desktop view - ${lang}`, async ({ browser }) => {
            ...
            try {
                ...
                await page.waitForSelector('.elementor-element[data-id="4a814d00"]', { 
                    state: 'visible',
                    timeout: 10000
                }).catch(error => {
        ...
        test(`Mobile view - ${lang}`, async ({ browser }) => {
            ...
            try {
                ...
                try {
                    ...
                    await page.waitForSelector('.elementor-element[data-id="4a814d00"]', { state: 'visible', timeout: 10000 });
                } catch (error) {
